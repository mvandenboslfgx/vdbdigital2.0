...
**Actuele HEAD:** `b918b12da3b1e606bbec0f366ed9f7ee0330c0cd`  
...
| HEAD | `b918b12da3b1e606bbec0f366ed9f7ee0330c0cd` |
...
Volledige tip bevat ADR `31170f8`, Phase 0 merge `8453f5b`, RC6/cherry-picks, en alle i18n-afrondingscommits tot `b918b12`. Belangrijke domeincommits (nieuwste eerst, selectie):

- `b918b12` — query-preserving switcher, seed/e2e shop, 320px overflow, FAB fallback  
...
**Actuele tip voor alle verdere discussie:** `b918b12da3b1e606bbec0f366ed9f7ee0330c0cd` op `integration/visual-rc6-i18n-foundation`.

  ...
  admin: {
    ...
    page: {
      ...
      customers: {
        ...
        inviteRegistered:
          "Customer created. The invitation is registered (the token is not logged in the UI). Share the invitation email securely.",
        contacts: "Contacts",
        ...
        internalNotesHint: "Never visible in the customer portal.",
      ...
      documents: {
        ...
        scanNotRun: "Virus scan not run yet",
        fileName: "File name",
        mimeType: "MIME",
        size: "Size",

    ...
    <>
      <Section variant="dark" className="pt-12">
        <Container>
          ...
          <p className="text-body-lg text-muted prose-width">{t("forms.contactIntro")}</p>
        </Container>
      </Section>
        ...
        <Container>
          <div className="grid lg:grid-cols-2 gap-10">
            ...
            <div className="space-y-8">
              ...
              <div>
                <h2 className="text-h3 text-light-foreground mb-3">{t("forms.whatsapp")}</h2>
                <WhatsAppButton message={t("forms.whatsappMessageContact")} />
              </div>
              <div>
                <h2 className="text-h3 text-light-foreground mb-3">{t("forms.preferQuote")}</h2>
                <p className="text-small text-light-muted mb-3">{t("forms.preferQuoteBody")}</p>
                <a
                  href="/quote"
